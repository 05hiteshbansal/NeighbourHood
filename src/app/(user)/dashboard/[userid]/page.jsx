...
import UserData from '@/model/UserData'
 ...
 dbConnect()
const uri = params.userid;
//console.log(uri, "123");
const data= await UserData.findById(uri);
  return (
     <div>
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 h-full mx-auto flex flex-wrap items-center ">
      ...
      <Image alt="profile_pic" className="lg:w-4/5 w-full h-[500px]  object-cover object-center rounded" width={400} height={500} src={data.imageurl}/>
      </div>
